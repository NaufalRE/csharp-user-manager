...
namespace UserManager.Class
{
    class BluetoothService
    {
        ...
        //        _tempTableHolder.Columns.Add("Device MAC");
        //        _tempTableHolder.Columns.Add("Device Name");
        //        _tempTableHolder.Columns.Add("Signal Strength");
        //        _tempTableHolder.Columns.Add("Pair Status");
